...
const owner1 = new OwnerClass("Иванов", "Константин", "Викторович", new Date(1973, 12, 20), TypeOfDocument.Passport, "1234", "567890");
const car1 = new CarImpl("Toyota", "Elysion", 2021, "QWERTYU789632", "ABC123", owner1, BodyType.Sedan, CarClass.Luxury);
const motorbike1 = new MotorbikeImpl("Эндуро ", "Kayo ", 2024, "SRFGGDFGHYHB8889", "XYZ789", owner1, "Sport", true);
